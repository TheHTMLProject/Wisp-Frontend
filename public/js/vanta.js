!function (e, t) {
    ...
    r.VantaBase = class {
        ...
        windowMouseMoveWrapper(e) {
            ...
            const s = e.clientX - t.left
                , i = e.clientY - t.top;
            s >= 0 && i >= 0 && s <= t.width && i <= t.height && (this.mouseX = s,
                this.mouseY = i,
    ...
    class p extends a {
        ...
        resize() {
            super.resize(),
                this.p5 && this.p5.resizeCanvas && this.p5.resizeCanvas(this.width, this.height)
        }
    }
